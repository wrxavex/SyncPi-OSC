...
def display_main_info(time_now):
    ...
    rect_device7 = text_surface_device7.get_rect(center=(45, 193))
    rect_device8 = text_surface_device8.get_rect(center=(93, 193))
    rect_device9 = text_surface_device9.get_rect(center=(141, 193))
    rect_device10 = text_surface_device10.get_rect(center=(189, 193))
    rect_device11 = text_surface_device11.get_rect(center=(237, 193))
    rect_device12 = text_surface_device12.get_rect(center=(285, 193))
