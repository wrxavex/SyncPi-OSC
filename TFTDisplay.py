...
def display_main_info(time_now):
    ...
    rect_device1 = text_surface_device1.get_rect(center=(45, 168))
    rect_device2 = text_surface_device2.get_rect(center=(93, 168))
    rect_device3 = text_surface_device3.get_rect(center=(141, 168))
    rect_device4 = text_surface_device4.get_rect(center=(189, 168))
    rect_device5 = text_surface_device5.get_rect(center=(237, 168))
    rect_device6 = text_surface_device6.get_rect(center=(285, 168))
