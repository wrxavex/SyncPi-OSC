...
def display_main_info(time_now):
    ...
    rect_device2 = text_surface_device2.get_rect(center=(58, 168))
    rect_device3 = text_surface_device3.get_rect(center=(98, 168))
    rect_device4 = text_surface_device4.get_rect(center=(138, 168))
    rect_device5 = text_surface_device5.get_rect(center=(178, 168))
    rect_device6 = text_surface_device6.get_rect(center=(218, 168))
    rect_device7 = text_surface_device7.get_rect(center=(18, 198))
    rect_device8 = text_surface_device8.get_rect(center=(58, 198))
    rect_device9 = text_surface_device9.get_rect(center=(98, 198))
    rect_device10 = text_surface_device10.get_rect(center=(138, 198))
    rect_device11 = text_surface_device11.get_rect(center=(178, 198))
    rect_device12 = text_surface_device12.get_rect(center=(218, 198))
