...
def display_main_info(time_now):
    ...
    rect_device1 = text_surface_device1.get_rect(center=(25, 168))
    rect_device2 = text_surface_device2.get_rect(center=(81, 168))
    rect_device3 = text_surface_device3.get_rect(center=(137, 168))
    rect_device4 = text_surface_device4.get_rect(center=(193, 168))
    rect_device5 = text_surface_device5.get_rect(center=(249, 168))
    rect_device6 = text_surface_device6.get_rect(center=(305, 168))
    rect_device7 = text_surface_device7.get_rect(center=(25, 198))
    rect_device8 = text_surface_device8.get_rect(center=(81, 198))
    rect_device9 = text_surface_device9.get_rect(center=(137, 198))
    rect_device10 = text_surface_device10.get_rect(center=(193, 198))
    rect_device11 = text_surface_device11.get_rect(center=(249, 198))
    rect_device12 = text_surface_device12.get_rect(center=(305, 198))
